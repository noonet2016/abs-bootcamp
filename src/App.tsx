...
export default function App() {
  ...
  return <MotionConfig reducedMotion="user"><main>
    ...
    {view === 'home' && <section className="home-intro"><p className="eyebrow">พร้อมแล้วหรือยัง?</p><h2>ดูข้อมูลก่อน แล้วไปทำภารกิจบนกระดานจริง</h2><div className="home-steps"><div><b>1</b><span>เรียนรู้สถานที่</span></div><div><b>2</b><span>สุ่มภารกิจทีม</span></div><div><b>3</b><span>วางรูปบนตาราง</span></div><div><b>4</b><span>สั่งหุ่นยนต์เดิน</span></div></div></section>}
